...
// saves the ustate.json file with the current Unikernel state
func (u *Unikontainer) InitialSetup() error {
	u.State.Status = specs.StateCreating
	// TODO: should we really create this base dir
...
func (u *Unikontainer) Exec() error {
	...
	if rootFsDevice.IsBlock {
		...
		// TODO: umount and rm might need some retries
...
func (u *Unikontainer) AwaitReexecStarted() error {
	...
	err := ensureValidSockAddr(sockAddr)
	if err != nil {
		return err
	}
	return awaitMessage(sockAddr, ReexecStarted)
}
...
func (u *Unikontainer) AwaitAckReexec() error {
	...
	return awaitMessage(sockAddr, AckReexec)
}
...
func (u *Unikontainer) AwaitStartExecve() error {
	...
	return awaitMessage(sockAddr, StartExecve)
}
...
func (u *Unikontainer) SendReexecStarted() error {
	...
	return sendIPCMessageWithRetry(sockAddr, ReexecStarted)
}
...
func (u *Unikontainer) SendAckReexec() error {
	...
	return sendIPCMessageWithRetry(sockAddr, AckReexec)
}
...
func (u *Unikontainer) SendStartExecve() error {
	...
	return sendIPCMessageWithRetry(sockAddr, StartExecve)
}
